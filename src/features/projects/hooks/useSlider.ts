...
export function useSlider(sliderRef: RefObject<HTMLDivElement | null>) {
      ...
      `;
            ...
            slide.addEventListener('click', (e) => {
                if (state.dragDistance < 10 && !state.hasActuallyDragged && item.url) {
                    // Use location to avoid nextjs-no-client-side-redirect warning
        ...
        // handleWheel without preventDefault to allow passive: true
